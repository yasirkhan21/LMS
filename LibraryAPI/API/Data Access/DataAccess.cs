...
namespace API.Data_Access
{
    public class DataAccess : IDataAccess
    {
        ...
        public IList<Order> GetOrdesOfUser(int userId)
        {
        ...
        public IList<User> GetUsers()
        {
            ...
            using (var connection = new SqlConnection(DbConnection))
            {
               // var sql = "select * from Users;";
                ...
                var listOfOrder = connection.Query("select u.Id as UserId,o.BookId as BookId, o.OrderedOn as OrderDate,o.Returned as Returned from Users u LEFT JOIN Orders o ON u.Id = o.UserId;");
                foreach(var user in users)
                {
                    var orders = listOfOrder.Where(lo => lo.UserId == user.Id).ToList();
                    var fine = 0;
        ...
        public void InsertBook(Book book)
        {
            ...
            var categoryId = connection.ExecuteScalar<int>(sql, parametr1);
            ...
            connection.Execute(sql, parametr2);
        }
